...
var CConditionalPortal = function(_a) {
  ...
  return typeof window !== "undefined" && portal ? (0, import_react_dom.createPortal)(children, document.body) : import_react.default.createElement(import_react.default.Fragment, null, children);
};
...
var CDropdown = (0, import_react.forwardRef)(function(_a, ref) {
  var _b;
  var children = _a.children, alignment = _a.alignment, _c = _a.autoClose, autoClose = _c === void 0 ? true : _c, className = _a.className, dark = _a.dark, direction = _a.direction, _d = _a.offset, offset2 = _d === void 0 ? [0, 2] : _d, onHide = _a.onHide, onShow = _a.onShow, _e = _a.placement, placement = _e === void 0 ? "bottom-start" : _e, _f = _a.popper, popper2 = _f === void 0 ? true : _f, _g = _a.portal, portal = _g === void 0 ? false : _g, _h = _a.variant, variant = _h === void 0 ? "btn-group" : _h, _j = _a.component, component = _j === void 0 ? "div" : _j, _k = _a.visible, visible = _k === void 0 ? false : _k, rest = __rest(_a, ["children", "alignment", "autoClose", "className", "dark", "direction", "offset", "onHide", "onShow", "placement", "popper", "portal", "variant", "component", "visible"]);
...
var CDropdownMenu = (0, import_react.forwardRef)(function(_a, ref) {
  ...
  var _c = (0, import_react.useContext)(CDropdownContext), alignment = _c.alignment, dark = _c.dark, dropdownMenuRef = _c.dropdownMenuRef, popper2 = _c.popper, portal = _c.portal, visible = _c.visible;
        ...
        import_react.default.createElement(
          ...
          import_react.default.createElement(
            ...
            import_react.default.createElement(
              ...
              import_react.default.createElement(CModalContent, __assign({}, rest, { ref: modalContentRef }), children)
            )
          )
        )
      );
...
var CPopover = function(_a) {
  ...
  return import_react.default.createElement(
    import_react.default.Fragment,
    null,
    import_react.default.cloneElement(children, __assign(__assign(__assign({ ref: togglerRef }, (trigger === "click" || trigger.includes("click")) && {
      onClick: function() {
    ...
    typeof window !== "undefined" && (0, import_react_dom.createPortal)(import_react.default.createElement(Transition$1, { in: _visible, mountOnEnter: true, nodeRef: popoverRef, onEnter: onShow, onExit: onHide, timeout: {
      enter: 0,
      exit: 200
...
var CTooltip = function(_a) {
  ...
  return import_react.default.createElement(
    ...
    typeof window !== "undefined" && (0, import_react_dom.createPortal)(import_react.default.createElement(Transition$1, { in: _visible, mountOnEnter: true, onEnter: onShow, onExit: onHide, timeout: {
      enter: 0,
      exit: 200
    }, unmountOnExit: true }, function(state) {
      return import_react.default.createElement(
