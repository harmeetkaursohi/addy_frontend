...
export const SelectAtLeastOnePageForDraft = "Please Select at least one page to save post in draft!"
...
export const NotConnectedDraft="You aren’t connected to any social media accounts right now. Connect to begin creating drafts and posts!"
