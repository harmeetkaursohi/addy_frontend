                        ...
                        <ul className="review_list">
                          {results?.map((post, index) => {
                            return removedPosts?.some(
                              ...
                              >
                                <li>
                                  <div className="d-flex gap-3 review_list_items_outer align-items-center">
                                    <div
                              ...
                              >
                                <div className="d-flex align-items-center gap-3 not_available_content_wrapper">
                                <div className={"disabled-table-grid"} style={{position:"relative"}}>
                                  <img
