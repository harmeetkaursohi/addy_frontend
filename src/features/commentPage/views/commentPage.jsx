                        ...
                        <div className="col-lg-4 col-md-6 col-sm-12 p-0">
                            <div className='user_comment_outer'>
                                ...
                                <div className='post_total_comment_outer'>
                                    ...
                                    {/* individual likes===================== */}
                                    <div className='likes_comment_wrapper cmn_padding'>
                                        <h3 className='discover_hedaing'><img className="me-3" src={heart_icon} height="24px" width="24px" />Likes</h3>

                                        <h3 className='discover_hedaing'> <img className="me-3" height="24px" width="24px" src={comment_icon} />Comment</h3>
                                        <h3 className='discover_hedaing'><img className="me-3" height="24px" width="24px" src={share_icon} />Share</h3>
                                ...
                                <div className='post_comment_wrapper cmn_padding'>
                                    <img src={smile_img} height="22px" width="22px" />
                                        ...
                                        <button className='cmn_small_heading post_btn'>Post </button>
                                </div>
                                </form>
                            </div>
                        </div>
