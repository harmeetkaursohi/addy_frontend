                                    ...
                                    <div className='login_form'>
                                        <form onSubmit={formik.handleSubmit}>
                                            ...
                                            <div className='rememberPass_outer mt-2'>
                                                ...
                                                {/*======= login with  google =======*/}
                                                <a className=''
                                                   href={`${import.meta.env.VITE_APP_OAUTH2_BASE_URL}/google?redirect_uri=https://0be0-2402-3a80-1a65-bdbb-718a-ffb1-45f1-8620.ngrok-free.app/auth-redirect`}>
                                                ...
                                                <a className=''
                                                   href={`${import.meta.env.VITE_APP_OAUTH2_BASE_URL}/facebook?redirect_uri=https://0be0-2402-3a80-1a65-bdbb-718a-ffb1-45f1-8620.ngrok-free.app/auth-redirect`}>
                                                    <div className="google_img_outer login_btn login_google_btn">
                                                        <img src={fbImg}/>
