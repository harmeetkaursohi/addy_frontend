...
const Insight = () => {
  const enabledSocialMedia = {
    ...
    isInstagramEnabled:
      `${import.meta.env.VITE_APP_ENABLE_INSTAGRAM}` === "true",
    isLinkedinEnabled: `${import.meta.env.VITE_APP_ENABLE_LINKEDIN}` === "true",
    isPinterestEnabled:
      `${import.meta.env.VITE_APP_ENABLE_PINTEREST}` === "true",
  };
    ...
    if (typeof getPostDataWithInsightsData?.data === "object") {
      Object.keys(getPostDataWithInsightsData?.data).map(function (v) {
        setInsightsCache((prevCache) => ({
          ...prevCache,
          [v]: getPostDataWithInsightsData?.data[v],
        }));
      });
    }
  ...
  const FacebookAndInstagramDemoGraphics = () => {
    return (
      <>
        {/* audience by age */}
        <div className="col-xl-6 col-lg-6 xol-md-12 col-sm-12">
          <div
            className={
              ...
              (getDemographicsInsightData?.data?.age !== null
                ? "cmn_height"
                : "")
            }
          >
            ...
            <div className="social_media_dropdown">
                ...
                <Dropdown.Menu>
                  <Dropdown.Item>
                    <ul className="Social_media_wrapper">
                      {!connectedFacebookPages?.length && (
                        <li>
                          <div className="Social_media_platform">
                            <h3>No Page is Connected yet</h3>
                          </div>
                        </li>
                      )}
              ...
              <Dropdown className="chooseplatfrom_dropdown_btn">
                ...
                <Dropdown.Menu>
                  <Dropdown.Item>
                    <ul className="Social_media_wrapper">
                      {!connectedInstagramPages?.length && (
                        <li>
                          <div className="Social_media_platform">
                            <h3>No Page is Connected yet</h3>
                          </div>
              ...
              <Dropdown className="chooseplatfrom_dropdown_btn">
                ...
                >
                  <i
                    className={`fa-brands fa-pinterest me-3 `}
                ...
                <Dropdown.Menu>
                  <Dropdown.Item>
                    <ul className="Social_media_wrapper">
                      {!connectedPinterestBoards?.length && (
                        <li>
                          <div className="Social_media_platform">
                            <h3>No Page is Connected yet</h3>
                          </div>
            ...
            {selectedPage === null || selectedPage === undefined ? (
              <div className={"select-page-outer"}>
                ...
                <div className={"select-page-text-outer ms-2"}>
                  <div className={"no-account-txt text-center mb-3"}>
                    No Account is Selected yet
                  </div>
                  <div className={"select-account-txt"}>
                    Please select page from these platforms to check insights.
                  </div>
                </div>
              </div>
            ) : (
              <>
                ...
                <div className="overview_tabs_outer">
                  <div className="days_outer reach-engagement-select">
                    ...
                    {selectedInsightSection === "Demographics" && (
                      <select
                        disabled={selectedPage?.socialMediaType === "FACEBOOK"}
                        className=" days_option box_shadow"
                  ...
                  >
                    ...
                    <Tab eventKey="Overview" title="Overview">
                      {!getAccountReachedAndAccountEngagedData?.loading && (
                        <>
                          {getAccountReachedAndAccountEngagedData?.data?.reach
                            ?.previousData?.data <
                          getAccountReachedAndAccountEngagedData?.data?.reach
                            ?.presentData ? (
                            <h3 className="overview_text">
                              You reached{" "}
                              <span className="hightlighted_text color-growth">
                                +
                                {calculatePercentageGrowthFor(
                                  getAccountReachedAndAccountEngagedData?.data
                                    ?.reach?.previousData?.data,
                                  getAccountReachedAndAccountEngagedData?.data
                                    ?.reach?.presentData,
                                  2
                                )}
                              ...
                              more accounts compared to{" "}
                              {
                                getAccountReachedAndAccountEngagedData?.data
                                  ?.reach?.previousData?.dateRange
                              }
                            </h3>
                          ) : (
                            <h3 className="overview_text">
                              This indicates a decline of{" "}
                              <span className="hightlighted_text color-decline">
                                {Math.abs(
                                  calculatePercentageGrowthFor(
                                    getAccountReachedAndAccountEngagedData?.data
                                      ?.reach?.previousData?.data,
                              ...
                              in the number of accounts reached compared to the
                              period of{" "}
                              {
                                getAccountReachedAndAccountEngagedData?.data
                                  ?.reach?.previousData?.dateRange
                      ...
                      <div className="account_reach_overview_wrapper">
                                ...
                                getAccountReachedAndAccountEngagedData?.data
                                  ...
                                  <>
                                    ...
                                    <span className="hightlighted_text color-growth">
                                      +
                                      {calculatePercentageGrowthFor(
                                        getAccountReachedAndAccountEngagedData
                                          ?.data?.reach?.previousData?.data,
                                        getAccountReachedAndAccountEngagedData
                                          ?.data?.reach?.presentData,
                                        2
                                      )}
                                      %
                                    </span>
                                ...
                                getAccountReachedAndAccountEngagedData?.data
                                  ...
                                  <>
                                    ...
                                    <span className="hightlighted_text color-growth">
                                      ...
                                      {calculatePercentageGrowthFor(
                                        getAccountReachedAndAccountEngagedData
                                          ?.data?.engagement?.previousData
                                          ?.data,
                                        getAccountReachedAndAccountEngagedData
                                          ?.data?.engagement?.presentData,
                                        2
                                      )}
                                      %
                                    </span>
                        ...
                        <div className="account_reach_overview_outer">
                          ...
                          <h4 className="cmn_text_style">
                            ...
                            ) : getTotalFollowersData?.data?.followers_count ===
                                null ||
                              getTotalFollowersData?.data?.followers_count ===
                                undefined ? (
                              "N/A"
                      ...
                      <div className="account_reach_graph_outer">
                        ...
                        <div className="page_title_header">
                          <div className="page_title_container">
                            <div className="page_title_dropdown">
                              {selectedPage?.socialMediaType ===
                                ...
                                <div>
                                  {
                                    getAllByCustomerIdData?.data?.find(
                                      (socialMediaAccount) =>
                                        socialMediaAccount?.provider ===
                                        "PINTEREST"
                                    )?.name
                                  }
                                </div>
                              ...
                              {selectedPage?.socialMediaType === "FACEBOOK" && (
                                <select
                                  ...
                                  onChange={(e) => {
                                    handleGraphPageChange(
                                      e.target.value,
                                      "FACEBOOK"
                                    );
                                  }}
                                >
                                  {connectedFacebookPages?.map(
                                    (page, index) => {
                                      return (
                          ...
                          <div className="account_info mt-2">
                            {reportGraphSectionData?.data?.Accounts_Reached !==
                              undefined && (
                              <div className="account_group">
                                <div className="account_reached cmn_chart_btn"></div>
                                <h4 className="cmn_headings">
                                  Accounts Reached
                                </h4>
                              </div>
                            )}
                            {reportGraphSectionData?.data?.Followers !==
                              undefined && (
                              <div className="account_group">
                      ...
                      <Tab eventKey="Demographics" title="Demographics">
                        ...
                        <div className="row">
                          {selectedPage?.socialMediaType === "LINKEDIN" ? (
                            ...
                            <FacebookAndInstagramDemoGraphics />
                          )}
                        </div>
                      </Tab>
                    )}
