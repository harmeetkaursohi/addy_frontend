...
//                                                     <img src={calendar_img} alt="" className="me-2" height="20px"
//                                                          width="20px"/>
//                                                     Last Week
//                                                 </Dropdown.Toggle>
//
                                        ...
                                        <>
                                            ...
                                            <div className="overview_tabs_outer">
                                                <div className="days_outer reach-engagement-select">
                                                    {
                                                        selectedInsightSection === "Overview" &&
                                                        <select className=" days_option box_shadow mb-2"
                                                    ...
                                                    }
                                                    {
                                                        ...
                                                        <select disabled={selectedPage?.socialMediaType === "FACEBOOK"}
                                                                className=" days_option box_shadow mb-2"
...
//                                         <img src={men_img}/>
//                                         <h3 className="cmn_text_style pt-4">amanarora_28</h3>
//                                         <h6 className="cmn_text pt-2">
//                                             In publishing and graphic design, Lorem ipsum is a
//                                             placeholder text commonly used{" "}
//                                         </h6>
