...
import {getUserInfo, updateProfilePic} from "../../app/actions/userActions/userActions";
                    ...
                    <div className="editProfile_wrapper mt-3">
                        <div className="change_profile_outer">
                            <div className="user_pic_container">
                                {
                                    updateProfilePicData?.loading && <div className={"update-pic-loading"}>
                                        <RotatingLines
                                            strokeColor="#F07C33"
                                            strokeWidth="5"
                                ...
                                <img style={{opacity: updateProfilePicData?.loading ?".4":"1"}}
                                    src={userInfo?.data?.profilePic ? "data:image/jpeg; base64," + userInfo?.data?.profilePic : default_user_icon}
                                    className='user_pic '/>
                            </div>
