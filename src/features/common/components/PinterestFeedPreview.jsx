    ...
    return (
        ...
        <>
            ...
            <div className='preview_wrapper1 preview_img_container'>
                 ...
                 <div className={`img_container w-100 ${selectedFileType==="VIDEO" || mediatype=='VIDEO' ? "black_bg_color":""}`}>
                       {files.length > 0 &&<CommonSlider className={"pintereset_postpreview_container"} height="300px" files={files} selectedFileType={selectedFileType} caption={""} hashTag={""} ></CommonSlider>
                     } 
                     </div>
